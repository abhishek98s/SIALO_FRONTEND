  ...
  return (
    <section className="search-page max-w-[910px] w-full mx-auto">
      ...
      <div className="relative px-[0px] lg:px-[32px] -mt-[50px]">
        <div
          className={` mb-[10px] lg:mb-[20px] bg-neutral-90 border-neutral-86 rounded-[8px] px-[16px] pt-[20px]`}
        >
          ...
          <div className="nav-wrapper flex gap-[16px]">
            <div
              className={`loading-bg relative block text-[14px] text-center w-[60px] rounded-4 h-[28px]`}
            ></div>
            <div
              className={`loading-bg relative block text-[14px] text-center w-[60px] rounded-4 h-[28px]`}
            ></div>
