...
export default function Story({ story, img_ref, open }: StoryProps) {
  ...
  return (
    <button
      onClick={openStory}
      className={`${styles.stories_wrapper} block w-full mb-1 mr-[12px]`}
    >
      <div className="story relative h-[120px] border-neutral-80 overflow-hidden rounded-4">
        ...
        <figure className="absolute top-[4px] left-[4px] z-50 rounded-full overflow-hidden border-primary-60 w-[40px] h-[40px]">
          <Image
            src={story.user_image ? story.user_image : "/icons/icon-user.svg"}
