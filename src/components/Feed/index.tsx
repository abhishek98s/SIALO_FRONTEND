    ...
    return (
        <article className={`${style.feed_wrapper} border-neutral-86 px-[12px] pt-[20px] pb-[8px] bg-neutral-90`}>
            ...
            <div className="interaction-wrapper flex items-center gap-[8px] mb-[32px]">
                <div className="like max-w-[40px] w-full h-[40px] flex-center">
                ...
                <form className="comment-wrapper relative flex-grow">
                    <input type="text" placeholder="Haver something to say" className="bg-neutral-88 border-neutral-86 h-[44px] w-full p-[12px]" />
                    <Image src={`/icons/icon-comment.svg`} alt="icon-comment" width={24} height={20} className="absolute right-[8px] top-1/2 -translate-y-1/2" />
                </form>
            </div>
