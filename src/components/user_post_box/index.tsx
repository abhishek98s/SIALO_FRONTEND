...
export default function UserPostBox() {
    ...
    const [user_inputted_image_url, setUser_inputted_image_url] = useState<string>('');
    ...
    const clearImage = () => setImage_file(null);
    ...
    return (
        <>
            <form
                ...
                className={`b${styles.user_post_wrapper} transition-4 order-neutral-86 bg-neutral-90 mb-[16px] px-[12px] pt-[20px] pb-[10px] rounded-4`}>
                ...
                {image_file && <div className={`${styles.middle} relative rounded-4 border-neutral-40 w-[60px] h-[60px] mb-[16px]`}>
                ...
                <div className="down">
                    <div className="action flex gap-[4px]">
                        <Link as={"image"} href="" className="w-[40px] h-[40px] focus-visible-primary-45 flex-center rounded-full">
