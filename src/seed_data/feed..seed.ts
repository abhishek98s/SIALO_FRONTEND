...
export const feed_arr: IFeed[] = [
  {
    ...
    caption:
      "Just beat Dark Souls for the 5th time! Still one of my favorite games of all time.",
  ...
  },
  {
    ...
    caption:
      "Just built my new gaming PC and Im loving the performance! Anyone have any recommendations for good FPS games?",
    createdAt: "January 1, 2022",
    isLiked: true,
    likes: ["2", "2"],
    ...
    comments: [
      {
        ...
        comment:
          "Nice build! You should totally check out Overwatch or Rainbow Six Siege",
      },
    ],
  },
  {
    ...
    caption:
      "Just got my hands on the new PS5 and Im loving the graphics! Has anyone else tried the new God of War game?",
    createdAt: "January 1, 2022",
    isLiked: true,
    likes: ["2", "2"],
    ...
    comments: [
      ...
      },
      {
        ...
        comment:
          "Im still waiting for my PS5 to arrive.Cant wait to try it out!",
      },
    ],
  },
  {
    ...
    caption:
      "Just beat The Last of Us Part II and Im still reeling from the ending! Has anyone else finished it?",
    createdAt: "January 1, 2022",
    isLiked: true,
    likes: ["2", "2"],
  ...
  },
  {
    ...
    user_image: "/user-2.png",
    caption:
      "Just started playing Cyberpunk 2077 and Im loving the open world! Has anyone else tried it?",
    createdAt: "January 1, 2022",
    isLiked: true,
    likes: ["2", "2"],
    ...
    comments: [
      {
        ...
        comment_user_picture: "/user-5.png",
        comment:
          "Yeah, Ive been playing it nonstop! The open world is so immersive",
      },
      {
        user_id: 1,
        comment_user_name: "PvPGuru",
        comment_user_picture: "/user-3.png",
        comment:
          "Im still waiting for the bugs to get fixed.Heard its a bit glitchy",
      },
    ],
  },
];
