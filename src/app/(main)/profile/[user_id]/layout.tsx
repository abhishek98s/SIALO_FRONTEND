      ...
      <div className="lg:pl-[230px]">
        ...
        <section className="search-page max-w-[910px] w-full mx-auto">
          ...
          <div className="relative px-[0px] lg:px-[32px] -mt-[50px]">
            {!loading && (
              <div
                className={`${styles.profile_header} mb-[10px] lg:mb-[20px] bg-neutral-90 border-neutral-86 rounded-[8px] px-[16px] pt-[20px]`}
              >
                <UserProfileheader
                  user_id={user_id}
                  isAuthUser={isAuthUser}
                ...
                <div className="nav-wrapper flex gap-[16px]">
                  <Link
                    href={`/profile/${user_id}/feed`}
                    className={`${styles.nav} ${
                      currentPath == "feed" ? styles.active : ""
                    } relative block text-[14px] text-center w-[60px] h-[34px]`}
                  >
                    Feed
                  </Link>
                  <Link
                    href={`/profile/${user_id}/friends`}
                    className={`${styles.nav} ${
                  ...
                  <Link
                    ...
                    className={`${styles.nav} ${
                      currentPath == "photos" ? styles.active : ""
                    } relative block text-[14px] text-center w-[60px] h-[34px]`}
                  >
                    Photos
                  </Link>
