...
export const Setting = () => {
  ...
  const onPasswordSubmit = async (e: any) => {
    ...
    try {
      ...
      const response = await axiosInstance.patch(
        `${APP_BASE_URL}/auth/changePassword`,
  ...
  return (
    <section
      className={`setting-wrapper pt-[24px] px-[12px] max-w-[400px] w-full mx-auto`}
    >
      <Toaster
        position="top-right"
        reverseOrder={false}
      ...
      <form className="mb-[40px] w-full" onSubmit={onPasswordSubmit}>
        <h3 className="mb-[12px] text-[18px] font-bold color-primary-60">
          Change password
        </h3>
        ...
        <div className="input-wrapper mb-[12px]">
          <label
            ...
            className="mb-[8px] text-[14px] block color-neutral-30"
          >
            Current Password
          </label>
          <input
            ...
            className="bg-neutral-88 rounded-8"
          />
        </div>
      ...
      <article className="w-full">
        <h3 className="mb-[4px] text-[18px] font-bold color-primary-60">
          Delete Account
        </h3>

        <p className="text-[14px] color-neutral-40 leading-[1.5] mb-[24px]">
          Deleting the account will delete all the data from the platform and
          access to the services. Account Deletion is final. There is no way to
          restore the account.
        </p>

        <button className="error-btn max-w-[75px] w-full h-[48px] font-bold bg-error-80 border-error-50 color-neutral-0 text-[14px] inline-flex justify-center items-center">
          Delete
        </button>
      </article>
    </section>
